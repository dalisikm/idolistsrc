...
<head>
  ...
  <title>HashClub后台管理</title>
  <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/layui/2.5.4/css/layui.min.css'>
...
<div class="layui-row" style = "margin-top:18px;">
    ...
    <div class="layui-input-block">
      <input type="url" id = "url" name="url" required  lay-verify="required|url" placeholder="请输入官网网址" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">项目名称</label>
    <div class="layui-input-block">
      <input type="text" id = "title" name="title" required  lay-verify="required" placeholder="请输入项目名称" autocomplete="off" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
